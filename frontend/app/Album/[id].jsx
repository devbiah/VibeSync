...
export default function AlbumDetail() {
    ...
    useEffect(() => {
        const fetchAlbum = async () => {
            try {
                const albumResponse = await fetch(`http://localhost:8000/artist/albums/${id}`);
        ...
        const fetchSongs = async () => {
            try {
                const songsResponse = await fetch(`http://localhost:8000/artist/albums/${id}/musics`);
        ...
        <View style={styles.container}>
            ...
            <View style={styles.albumContainer}>
                ...
                <View style={styles.textContainer}>
                    ...
                    <Image style={styles.play} source={require("../../assets/svg/player.svg")} />
                </View>
            </View>
